    ...
    return (
        <div className="flex flex-col mt-32 items-center gap-2 ">
            ...
            <div className="flex flex-col mt-10 px-5 gap-8 mb-10">
                <ImageContainer imageUrl={'https://dr-aqeel.com/wp-content/uploads/2024/01/a7f350_f3639d34dc8d4eafbd86e800ba871e0emv2.png'}
                    altText="Picture 1"
                    title="Consultations"
                ...
                <ImageContainer imageUrl={'https://dr-aqeel.com/wp-content/uploads/2024/01/a7f350_f5b282c756e4499195abd5019669619amv2.png'}
                    altText="Picture 2"
                    title="Testing"
                ...
                <ImageContainer imageUrl={'https://dr-aqeel.com/wp-content/uploads/2024/01/a7f350_cc6ffef0eef6407d853d75ff2414fb33mv2.png'}
                    altText="Picture 3"
                    title="Treatment"
                ...
                <ImageContainer imageUrl={'https://dr-aqeel.com/wp-content/uploads/2024/01/a7f350_767221498ff34915b92478bc496310a6mv2.png'}
                    altText="Picture 4"
