...
const ServicesSect: React.FC = () => {
    ...
    return (
        <div className='text-center '>
            <div className="bg-gray-200 flex flex-col lg:flex-row items-center lg:items-start lg:justify-center gap-20 lg:gap-10 p-8" ref={ref}>
            ...
            >
                <Link href={`/${localActive}/services`}>
                    <button
                        className='relative z-30 mt-1 mb-[-4rem] h-8 lg:h-16 w-36 lg:w-[14rem] rounded-full text-white lg:text-xl font-semibold bg-red-800 border-white border-2 hover:bg-white hover:text-red-800 hover:border-red-800 '>
                        {t('See Services')}
                    </button>
                </Link>
            </motion.div>
