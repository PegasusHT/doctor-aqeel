        ...
        <div className="bg-violet-100 pt-8 md:pt-20">
            ...
            items-center md:items-start md:ml-20">
                <div className="flex flex-col items-center lg:items-start">
                    <div className="pb-4 text-2xl lg:text-3xl font-bold" style={{color:'#961B1E'}}>Contact Me</div>
                    <div className="text-lg lg:text-xl pb-1">info@dr- aqeel.com</div>
                    <div className="text-lg lg:text-xl pb-3">Dubai @ Sharjah</div>
                    <div className="">
                ...
                <div className="mt-12 md:mr-10 md:mt-0">
                    <h1 className='text-xl lg:text-2xl ml-1 md:ml-0 font-semibold' style={{color:'#961B1E'}}>Subscribe to Get My Newsletter</h1>
